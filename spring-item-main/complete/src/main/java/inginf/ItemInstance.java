...
public class ItemInstance {
    ...
    ArrayList<Characteristic> UsedBy = new ArrayList<Characteristic>();
    public ArrayList<Characteristic> getUsedBy() {
        return UsedBy;
    }

    public boolean isInConfig(ArrayList<Characteristic> config) {
    ...
    public void printConfStructure(
        ...
        System
            .out
            .println(Name + ":");
        getRepresents().printConfStructure(configuration, inlineCount + 1);
    }
